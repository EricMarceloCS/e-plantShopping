...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Natural House, where nature is home!</p>
      <p className="about-us-content">
        At Natural House we are committed to brining natural beauty back into the lives of our customers. We pride ourselves
        in providing products that suit the needs of our customers.
      </p>
      ...
      <p className="about-us-content">
        Our products are wonderful additions to your home or office.
      </p>
      ...
      <p className="about-us-content">
        Join us in bringing nature back into our lives, our homes and offices.
      </p>
    </div>
  );
}
